...
static void lcd_ltdc_msp_init(void)
{
    ...
    gpio.Pin = GPIO_PIN_15 | GPIO_PIN_14 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_11 |
               GPIO_PIN_10 | GPIO_PIN_9 | GPIO_PIN_0 | GPIO_PIN_8 | GPIO_PIN_7 |
               GPIO_PIN_6 | GPIO_PIN_1 | GPIO_PIN_5 | GPIO_PIN_3 | GPIO_PIN_4;
...
static void lcd_ltdc_init(void)
{
    ...
    hltdc.Init.TotalHeigh = RK043FN48H_VSYNC + LCD_DEFAULT_HEIGHT + RK043FN48H_VBP +
                            RK043FN48H_VFP - 1U;
...
void LCD_init(void)
{
    ...
    memset((void *)LCD_LAYER_0_ADDRESS, 0, LCD_DEFAULT_WIDTH * LCD_DEFAULT_HEIGHT * sizeof(lv_color_t));
    SCB_CleanInvalidateDCache();

    lv_disp_draw_buf_init(&draw_buf, (void *)LCD_LAYER_0_ADDRESS, NULL,
